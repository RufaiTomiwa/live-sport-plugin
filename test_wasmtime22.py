...
try:
    ...
    print("set_stream_jw error:", e)

# Also dump memory here!
with open("wasmtime_mem_crash.bin", "wb") as f:
    f.write(global_memory.read(store, 0, global_memory.data_len(store)))
