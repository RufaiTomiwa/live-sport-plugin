...
print("Domain ptr:", domain)

set_stream = instance.exports(store)["set_stream"]

try:
    print("Executing set_stream...")
    set_stream(store, domain[0], domain[1], id1[0], id1[1], id2[0], id2[1], None)
except Exception as e:
    print("set_stream err:", e)

# Dump strings directly!
print("Reading memory after crash...")
try:
    # 1048572 is the pointer, 1080192 is NOT the length! 1080192 is the SECOND pointer!
    # Ah! __wbg_new_with_str_and_init is __wbg_new_b5d9e2fb389fef91(ptr, len).
    # Wait, the signature of __wbg_new_b5d9e2fb389fef91 is [i32, i32] -> [anyref]
    # Yes, it is ptr, len!
    # Why is len 1080192?!
    # Oh! Maybe the string is at 1080192 and the length is 1048572!
    print("String at 1080192:", global_memory.read(store, 1080192, 50).decode('utf8', 'ignore'))
except Exception as e:
    pass
