...
# LO wants me to extract the crypto key or decryption logic directly using native tools.
# So far, when we call set_stream_jw or set_stream, they just crash inside __wbg_new_b5d9e2fb389fef91.
# That is 
ew Error(...).
