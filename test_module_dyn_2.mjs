...
const fakeWindow = {
  ...
  location: { href: 'https://embed.st/embed/admin/admin-tennis-channel/1', origin: 'https://embed.st' },
...
global.navigator = fakeWindow.navigator;
...
async function run() {
  ...
  console.log('Exports:', Object.keys(lock));
  if (lock.init_wasm) lock.init_wasm();
