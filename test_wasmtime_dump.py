...
try:
    instance.exports(store)["set_stream_jw"](store, domain[0], domain[1], id1[0], id1[1], id2[0], id2[1], None)
except Exception as e:
    pass

mem = global_memory.read(store, 0, global_memory.data_len(store))
with open("wasm_mem_crash2.bin", "wb") as f:
    f.write(mem)
print("Dumped memory to wasm_mem_crash2.bin")
