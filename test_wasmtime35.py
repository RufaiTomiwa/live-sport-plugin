        ...
        def dummy(caller, *args):
            ...
            for res_type in func_type.results:
                if res_type == wasmtime.ValType.i32(): 
                    if name == "__wbg_instanceof_Window_c4b70662a0d2c0ce": res.append(1)
                    else: res.append(0)
...
# Actually, the domain is often just "embed.st" without https:// in some contexts. Let's try what we saw in Playwright.
# URL: https://embed.st/embed/admin/admin-tennis-channel/1
# Domain in browser is "embed.st"
