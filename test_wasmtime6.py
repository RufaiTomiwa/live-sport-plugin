...
# Okay, set_stream_jw takes exactly 6 parameters (3 strings).
# Let's write a python script to run this properly. We will intercept ALL memory writes!
    ...
    def make_dummy(name, func_type):
        def dummy(caller, *args):
            if name == "__wbg_fetch_e6e8e0a221783759":
                # It's calling fetch!
                # We can dump the memory right here!
                print("FETCH CALLED!")
