...
# Wait, __wbg_new_b5d9e2fb389fef91 has length 1080192?!
# 1,080,192 bytes? That's not a length, that's a POINTER!
# Ah! __wbg_new_with_str_and_init might take two pointers!
# Or it takes (ptr, len) but the arguments are swapped in my print?
