...
def pass_string(s):
    # What if they don't want us to pass the string length directly, but just an index into an array?
    # No, wasm-bindgen uses length.
...
import re
strings = re.findall(b"[a-zA-Z0-9., _-]{10,}", mem)
print(b"----".join(strings[:20]))
