...
global.WebAssembly.instantiateStreaming = async (resp, importObject) => {
  ...
  console.log("WASM IMPORTS KEYS:", Object.keys(importObject));
  if (importObject['./gasm_bg.js']) console.log('BG KEYS:', Object.keys(importObject['./gasm_bg.js']));
  const inst = await global.WebAssembly.instantiate(buffer, importObject);
  console.log("WASM EXPORTS KEYS:", Object.keys(inst.instance.exports));
  return inst;
