...
(async () => {
  ...
  await page.addInitScript(() => {
    // Wait, in the log we saw:
    // BROWSER: this.buffer === wasmMemory? undefined
    // WHICH MEANS window.wasmInstance WAS UNDEFINED AT THAT POINT!
    // That's why it didn't save the dump!
    // Let's hook fetch differently to get window.wasmInstance globally.
